...
//import { cookiesClient } from '@/app/layout';
...
const Users = () => {
  ...
  const calculateTotalPages = () => {
    if (filteredUsers === null) return 0;
  ...
  const totalActiveUser   = users !== null ? users.filter((e) => e.status === "active").length : 0;
  const totalInactiveUser = users !== null ? users.filter((e) => e.status === "inactive").length : 0;
  const numbers = [
