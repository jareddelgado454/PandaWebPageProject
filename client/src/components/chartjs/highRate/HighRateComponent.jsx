                ...
                loading ? (<div>loading</div>) : (
                    <>
                        {users && users.map((user, i) => (
                            <div key={i} className='bg-white rounded-lg h-[6rem] flex flex-row'>
                                ...
                                <div className='w-full flex flex-row justify-between'>
                                    <div className='flex flex-col justify-center gap-2'>
                                        <p className='text-black text-base font-semibold'>{ user.fullName }</p>
                                    ...
                                    <div className='text-green-500 flex justify-center items-center px-4'>
