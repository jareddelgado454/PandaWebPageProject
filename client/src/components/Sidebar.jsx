    ...
    <div className={`sidebar bg-gray-100 dark:bg-zinc-800 text-white transition-all ease-out duration-500 ${active ? 'active' : null}`}>
        <div className='flex flex-col items-center py-4 relative h-full px-4'>
            <div className={`w-full flex flex-row items-center ${active ? 'justify-between': 'justify-center'}`}>
                ...
                />
                <p className={`font-black drop-shadow-xl tracking-wider text-zinc-600 dark:text-white ${active ? 'block' : 'hidden'}`}>Panda CMS</p>
            ...
            <Separator />
            <ul className={`bg-zinc-600 dark:bg-green-panda shadow-xl transition-all rounded-md p-3 mt-4 ${active && 'w-full'}`}>
            ...
            <div className='w-full px-4 absolute bottom-4 transition-all'>
                ...
                <Separator />
                <div className={`bg-zinc-600 dark:bg-green-panda shadow-xl p-3 rounded-md mt-4 transition-all w-full ${active ? 'h-[6rem]' : 'h-[3rem]'}`}>
                    <div className='flex items-center w-full h-full gap-2'>
                        ...
                        <div className='overflow-hidden flex flex-col gap-1'>
                            <p className={`font-medium ${!active && 'hidden'}`}>Cristiano Ronaldo</p>
                            <p className={`text-xs text-gray-100 tracking-wide ${!active && 'hidden'}`}>test@gmail.com</p>
...
const Separator = () => {
    return(
        <div className='w-full h-[2px] bg-zinc-600 dark:bg-white' />
    )
}