        ...
        <div className='w-full h-full py-4 container mx-auto'>
            ...
            <div className='flex justify-center items-center px-8 md:px-2'>
                ...
                <p className='text-[#C0B2A9] leading-loose'>
                    Effective Date: December 30, 2023<br />

                    <strong>Acceptance of Terms</strong> <br />

                    The following terms and conditions govern all use of the Panda mobile app and its related services, features and functionalities (collectively referred to as the "Service"). The Service is owned and operated by The Panda M.A.R.S. LLC. Your use of the Service is subject to your acceptance of and compliance with these terms. These terms apply to all users of the Service, including, without limitation, users who are browsers, customers, merchants, and/or contributors of content.

                    <br /><strong>Description of Service</strong> <br />

                    The Service is a mobile app platform that connects automotive service professionals (referred to as "Technicians") with customers in need of automotive repair services. Customers can find, book and pay for services through the Service, while Technicians can manage their business, communicate with customers and accept payments through the Service. The Service is not an automotive repair service provider and is not responsible for the performance of the services provided by Technicians.

                    <br /><strong>User Accounts</strong> <br />

                    In order to use the Service, you must register for an account ("Account"). You are responsible for maintaining the confidentiality of your Account information and for all activities that occur under your Account. You agree to immediately notify The Panda M.A.R.S. LLC of any unauthorized use of your Account or any other breach of security. The Panda M.A.R.S. LLC will not be liable for any loss or damage arising from your failure to comply with this section. By creating your account, you agree to receive text messages at the number provided. Standard message and data rates apply.

                    <br /><strong>User Conduct</strong> <br />
                    ...
                    <br /><strong>Payment Terms</strong><br />
                    ...
                    <br /><strong>Disclaimers and Limitations of Liability</strong><br />
                    ...
                    <br /><strong>Modifications to Service</strong><br />
