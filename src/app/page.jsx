        ...
        <div className="w-full h-full py-8 sm:px-12 px-5 flex flex-col justify-center items-center shadow-xl">  
            <div className="xl:w-[1200px] w-full relative mb-10">
                ...
                <div className="absolute w-1/2 flex justify-center items-center top-[50px] right-4">
                    <img src="/image/phoneMap2.png" className="lg:w-[320px] md:w-[250px] w-[200px]  object-cover"/>
                </div>
            ...
            <motion.div ref={ref} style={{ scale : scaleProgress1, opacity : scaleProgress1 }} className="xl:w-[1200px] w-full grid grid-cols-1 md:grid-cols-3  mb-10 py-10">
                <div className="w-full text-center flex flex-col items-center justify-center py-8 pr-3">
                ...
                <div className="w-full text-center flex flex-col items-center justify-center py-8 px-3">
                    <div className="w-[45px] h-[45px] rounded-full bg-white flex justify-center items-center mb-2">
                ...
                <div className="w-full text-center flex flex-col items-center justify-center py-8 pl-3">
                    <div className="w-[45px] h-[45px] rounded-full bg-white flex justify-center items-center mb-2">
            ...
            <motion.div ref={ref2} style={{ scale : scaleProgress2, opacity : scaleProgress2, transition: 'background-color 1.2s ease' }} className="xl:w-[1200px] w-full flex flex-col mb-10 bg-zinc-800 rounded-3xl shadow-2xl shadow-gray-600/50 cursor-pointer hover:bg-zinc-900 " >
                <div className="lg:w-1/2 w-full pt-8 sm:pl-10 pl-3">
                    <h3 className="text-[35px]  text-white text-left font-bold">Family <span className="text-emerald-400">Legacy</span>, Business Vision</h3>
                </div>  
                <div className="w-full flex lg:flex-row flex-col px-3 my-4  mb-10">
                    <div className="lg:flex-1 w-full flex flex-col  sm:px-6 px-0">
                        <h4 className="text-[25px] text-gray-400 mb-5">The Panda is a mobile auto repair service CRM</h4>
                        <p className="text-gray-200 text-xl text-justify">Our founders have a long family history in the auto industry and a deep empathy for small business owners and barriers to success. We combined those two areas that we are highly passionate about and came to this wonderful conclusion. We care deeply about people and strongly believe that our experiences and expertise can help to empower people.</p>
                    </div>
                    <div className=" lg:w-[40%] w-full flex justify-center ">
                        <img src="/image/car.png" alt="image" className=" top-0 w-600 md:w-[400px]" />
                    </div>
                </div>
                <div className="w-full flex gap-x-1 text-[19px] text-emerald-300 font-bold items-center sm:pl-10 pl-3 pb-6 pt-4">
            ...
            <motion.div ref={ref3} style={{ scale : scaleProgress3, opacity : scaleProgress3 }} className="xl:w-[1200px] w-full flex lg:flex-row flex-col gap-7 mb-20">
              <div className="lg:w-1/2 w-full bg-zinc-800 rounded-3xl cursor-pointer hover:bg-zinc-900 shadow-2xl shadow-gray-600/50 containerDivChangeColor" style={{ transition: 'background-color 1.2s ease' }}>
              ...
              <div className="lg:w-1/2 w-full bg-zinc-800 rounded-3xl hover:bg-zinc-900 shadow-2xl shadow-gray-600/50 pb-6" style={{ transition: 'background-color 1.2s ease' }}>
                  <div className="w-full py-8 px-6">
                      <h3 className="text-[35px] text-white text-left font-bold">Where we are <span className="text-emerald-400">TODAY</span></h3>
                  </div> 
                  <div className="w-full px-6 mb-10 ">
                    <div className="flex gap-x-2 mb-1">
                        <RiCheckDoubleFill  className="text-emerald-400 text-[30px]"/>
                  ...
                  <div className="relative px-6 pt-4 ">
                    ...
                    <img src="/image/arrowTime.png" className="w-full"/>
                  </div>                
              </div>
            </motion.div>

            <div className="xl:w-[1200px] w-full relative mb-20">
                ...
                <div className="bg-zinc-800 hover:bg-zinc-900 rounded-3xl w-full flex lg:flex-row flex-col shadow-xl shadow-gray-600/50" style={{ transition: 'background-color 1.2s ease' }}>
                    <div className="lg:w-[50%] w-full flex flex-col p-8">
                        ...
                        <div className="flex lg:flex-row flex-col gap-2">
                            <button onClick={()=>handleDownloadClick("customer")} className="lg:w-1/2 w-full py-3 rounded-2xl bg-emerald-400 hover:bg-emerald-600 hover:text-white transition-colors text-[18px] font-bold cursor-pointer">Download customers app</button>
                            <button onClick={()=>handleDownloadClick("technician")} className="lg:w-1/2 w-full py-3 rounded-2xl bg-gray-100 hover:bg-gray-300 hover:text-zinc-900 text-zinc-900 transition-colors text-[18px] font-bold cursor-pointer">Download technicians app</button>
                        </div>
                    </div>
                    <div className="lg:w-[50%] w-full flex flex-col justify-center items-center">
                        <img src="/image/app.png" alt="app" className="sm:w-[400px] w-[300px] h-full object-cover"/>
                    </div>
                </div>
            </div>

            <div className="xl:w-[1200px] bg-zinc-800 rounded-3xl w-full mb-20 md:p-10 p-3">
                <div className="w-full rounded-3xl relative overflow-hidden mb-8">
                    ...
                    <img src="/image/services.jpeg" alt="services" className="w-full h-[500px] object-cover"/>
                </div>
                <div className="flex lg:flex-row flex-col">
                    ...
                    <div className="lg:w-1/2 w-full flex lg:flex-row flex-row-reverse items-center bg-zinc-700 rounded-3xl">
                        <div className="lg:w-[60%] w-full p-4">
                            <h3 className="text-white font-bold text-[25px]">Skilled Technician</h3>
                            <p className="text-gray-300 mb-2">Start enjoying all the benefits of being a registered technician at The Panda</p>
                            <button className="bg-emerald-400 hover:bg-emerald-500 hover:text-white transition-colors p-3 w-full rounded-lg md:text-[18px] text-[15px] font-semibold">Create an account</button>
                        </div>
                        <div className="lg:w-[40%] sm:w-[200px] w-[150px] p-3">
                            <img src="/image/technician.png" alt="technician" className="w-full"/>
                        </div>
                    </div>
                </div>
            </div>
