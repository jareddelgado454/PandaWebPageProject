...
export default function CarCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setIdentificationNumber(initialValues.identificationNumber);
    setErrors({});
  };
  const validations = {
    description: [],
    ...
    model: [{ type: "Required" }],
    year: [{ type: "Required" }],
    identificationNumber: [{ type: "Required" }],
  };
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.identificationNumber ?? value;
          }
          if (errors.identificationNumber?.hasError) {
            runValidationTasks("identificationNumber", value);
          }
          setIdentificationNumber(value);
        }}
        onBlur={() =>
          runValidationTasks("identificationNumber", identificationNumber)
        }
        errorMessage={errors.identificationNumber?.errorMessage}
        hasError={errors.identificationNumber?.hasError}
        {...getOverrideProps(overrides, "identificationNumber")}
      ></TextField>
      <Flex
