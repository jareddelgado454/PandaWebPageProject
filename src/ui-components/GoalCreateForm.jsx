...
export default function GoalCreateForm(props) {
  ...
  const [monthYear, setMonthYear] = React.useState(initialValues.monthYear);
  ...
  const resetStateValues = () => {
    ...
    setMonthYear(initialValues.monthYear);
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.monthYear ?? value;
          }
          if (errors.monthYear?.hasError) {
            runValidationTasks("monthYear", value);
          }
          setMonthYear(value);
        }}
        onBlur={() => runValidationTasks("monthYear", monthYear)}
        errorMessage={errors.monthYear?.errorMessage}
        hasError={errors.monthYear?.hasError}
        {...getOverrideProps(overrides, "monthYear")}
      ></TextField>
      <TextField
        label="Created at"
        isRequired={false}
