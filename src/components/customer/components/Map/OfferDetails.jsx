  ...
  return (
    <div className='absolute top-0 left-0 z-10 md:w-[31rem] 2xl:w-[36rem] h-[17rem] 2xl:h-[22rem]'>
      <div className='p-4 flex gap-4 h-full overflow-y-hidden'>
        ...
        <div className={`w-[85%] h-full overflow-y-scroll transition-all duration-300 ease-in-out animate__animated  ${ active ? 'block animate__bounceInDown' : 'animate__bounceOutUp' }`}>
