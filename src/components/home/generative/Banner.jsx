...
const Banner = () => {
  return (
    <div className='relative h-[100vh] w-full overflow-hidden text-[#E6D5C9]'>
        ...
        <div className='flex m-4 gap-4 absolute top-[30%] left-0'>
          <div className='bg-zinc-900/60 py-6 px-8 w-[40%] flex flex-col gap-8 rounded-lg'>
            <p className='tracking-widest text-5xl text-center font-black'>Panda Generative Artificial Intelligence</p>
