...
import { getTechnicianById } from "@/api";

const AccessWithEmailTechnician = ({
    ...
    try {
      ...
      if (nextStep?.signInStep === "CONFIRM_SIGN_UP") {
        ...
        return;
          ...
          console.log("Esta es la data del inicio de sesion tecnico line74", data);
...
export default AccessWithEmailTechnician;
