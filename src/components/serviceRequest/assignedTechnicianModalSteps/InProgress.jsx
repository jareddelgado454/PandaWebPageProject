        ...
        const session = await stripe.checkout.sessions.create(
          {
            ...
            success_url:`https://www.app.panda-mars.com/customer/request/${serviceAssigned.id}?paymentStatus=completed`,
            cancel_url:`https://www.app.panda-mars.com/customer/request/${serviceAssigned.id}?paymentStatus=failed`,
