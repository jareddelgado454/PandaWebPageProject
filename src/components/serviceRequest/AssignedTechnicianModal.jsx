...
import { handleUpdateStatusService, handleUpdateTechnicianLocationInService } from "@/api";
...
const AssignedTechnicianModal = ({ isOpen, onOpenChange, serviceAssigned }) => {
  ...
  const handleStartService = async() => {
    console.log("Haciendo cliiiiiiiiiiiiiiiiiiiiiiiiiiiiiiick", serviceAssigned.id);
    try {
              ...
              <div className="w-full h-[25%] bg-zinc-800 rounded-t-3xl shadowContainer p-4 z-40">
                ...
                {!inTheLocation ? (
                  ...
                  <div className="w-full flex gap-x-2">
                    <div className="w-[120px] py-2 rounded-md border-[2px] cursor pointer border-red-500 text-red-500">Send Report</div>
                    <div className="w-[120px] py-2 rounded-md border-[2px] cursor pointer border-emerald-500 text-white bg-emerald-500" onClick={()=>handleStartService()}>Start Service</div>
                  </div>
                )}
              </div>
            </ModalBody>
